        ...
        <div class="row">
            <div class="col-sm-4">
                <table class="table table-borderless">
                    <tbody>
                    <tr>
                        <td><button type="button" class="btn btn-default" style="width: 70%;"><a href="{{url('/teacher')}}">Dashboard</a></button></td>
                    </tr>
                    <tr>
                        <td><button type="button" class="btn btn-default" style="width: 70%;"><a href="{{url('/result')}}">Add Result</a></button></td>
                    </tr>
                    <tr>
                        <td><button type="button" class="btn btn-default" style="width: 70%;"><a href="{{url('upload-files')}}">Upload File</a></button></td>
                    </tr>
                    </tbody>
                </table>
